...
class UpdateScreen extends StatefulWidget {
  Info info;
  UpdateScreen(this.info);
  @override
  State<StatefulWidget> createState() {
    return UpdateScreenState(this.info);
  }
}

class UpdateScreenState extends State {
  Info gelenInfo;
  UpdateScreenState(this.gelenInfo);
  var dbHelper = DbHelper();
  var txtIzinSayisi = TextEditingController();

  @override
  void initState() {
    selectedDate = gelenInfo.sevkTarihi;
    donem = gelenInfo.donem;
    txtIzinSayisi.text = gelenInfo.izinSayisi.toString();
    super.initState();
  }
  ...
  void updateInfo(Info info) async {
    await dbHelper.updateInfo(dbHelper.hesapla(info));
